...
# Load preprocessed frame data
preprocessed_frames = torch.load('C:/Users/maher/Documents/KURF/Test/preprocessed/preprocessed_frames.pt')

# Inference
model = DVSGestureNet(16, neuron.IFNode)
...
x_inference = preprocessed_frames
output = model(x_inference.unsqueeze(0))
