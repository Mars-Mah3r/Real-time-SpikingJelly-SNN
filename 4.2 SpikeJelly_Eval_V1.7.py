...
def main():
    ...
    # Map the labels to the desired class names
    class_labels = ['arm roll', 'hand clap', 'left hand clockwise', 'left hand counter clockwise',
                    'left hand wave', 'right hand wave', 'right hand clockwise', 'right hand counter clockwise',
                    'air drums', 'air guitar', 'other gesture']

    mapped_labels_pred = [class_labels[label] for label in labels_pred]

    # Print the classified labels
    print(mapped_labels_pred)
